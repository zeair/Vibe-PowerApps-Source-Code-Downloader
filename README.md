...
- **Visual download tracking**: Downloaded files are automatically hidden from the file tree panel
- **Session-based hiding**: Hidden files reappear when you reload the page
...
4. The file will be automatically hidden from the file tree panel
5. Hidden files reappear when you reload the page
...
6. Content script hides the downloaded file from the tree panel
7. Hidden files are session-based (reappear on page reload)
...
### Downloaded files don't disappear from tree
- Check browser console for "Marked as downloaded (hidden)" messages
- Make sure the file tree sidebar is visible
- Hidden files are session-based - they will reappear after page reload

### Want to restore hidden files
- Simply reload the page - hiding is not persisted
